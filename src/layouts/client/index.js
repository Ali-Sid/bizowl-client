...
import SidebarSmallLinks from 'components/sidebar/components/SmallbarLinks';
		...
		<Box>
			<Box>
				<SidebarContext.Provider
					...
					>
					<Sidebar routes={routes} display='none' {...rest} isCollapse={isCollapse} setIsCollapse={setIsCollapse}/>
					{/* <SidebarSmallLinks/> */}
					<Box
						float='right'
						minHeight='100vh'
						...
						{getRoute() ? (
							<Box mx='auto'padding="0px !important" p={{ base: '20px', md: '30px' }} pe='20px' minH='100vh' pt='50px'>
								<Switch>
									{getRoutes(routes)}
