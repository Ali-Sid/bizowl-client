...
export default function HeaderLinks({secondary, currentUser} = {}) {
...
// Assuming `currentUser` is the current authenticated user
// useEffect(() => {
        ...
        >
          <Flex w="100%" mb="0px">
			{userData && (
				...
				color={textColor}
			  >
				👋&nbsp; Hey, {userData.firstName || (userData.email ? userData.email.replace(/^@.*/, "") : "") || "user"}
			  </Text>
			)}
          </Flex>
